      ...
      <div className="bg-[#092241] py-16">
        <div className="fix12  ">
          <div className="lg:flex justify-between items-center gap-10">
            <div className="leftCon lg:w-[500px] h-[480px]  flex-shrink-0 flex items-center justify-center">
              <img src="/investorRel/indoSpace.png" alt="" />
            </div>
            <div className="RightCon flex-1 lg:p-4 xl-768:mt-14">
              <h1 className="fpt-500 text-white pb-2 text-3xl leading-[33px] border-b-[#D7D7D7] border-b-[1px]">
